            ...
            <table class="sponsor-benefits-table">
                ...
                <tbody>
                    <tr class="sponsor-level-platinum">
                        ...
                        <td>$12,000</td>
                        <td>1</td>
                        <td>Best location right at the entrance</td>
                        <td>Featured onscreen in all rooms and YouTube after!</td>
                    ...
                    <tr class="sponsor-level-gold">
                        ...
                        <td>$8,500</td>
                        <td>4</td>
                        <td>Premier locations close to the center</td>
                        <td>Featured at breakfast, lunch, on popcorn, or lanyards (pick one)!</td>
                        <td><span class="checkmark">✓</span></td>
                        <td><span class="checkmark">✓</span></td>
                        <td>×</td>
                    </tr>
