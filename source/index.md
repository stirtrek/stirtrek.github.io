...
<div id="stirTrekHeroContainer">
    <div class="hero-grid">
        ...
        <div class="hero-cta-panel comic-panel-light">
            <a class="btn-comic" href="https://events.humanitix.com/stir-trek-2026-edition">
    ...
    <div class="home-two-panel">
        <div class="panel-text comic-panel" style="background-color: var(--stir-teal); color: #fff;">
            ...
            <ul class="benefits-list-inline">
                <li><i class="fa-solid fa-chalkboard-user"></i> <span>50+ Sessions of critical content</span></li>
                ...
                <li><i class="fa-solid fa-film"></i> <span>Screening of a great movie!</span></li>
        ...
        <div class="panel-text comic-panel" style="">
            <img src="/images/2026-hostage-movies.png" alt="Stir Trek logo">
            <h3>Hollywood didn't and plan around Stir Trek so this year we're showing 8 classics!!!</h3>
            <ul>
